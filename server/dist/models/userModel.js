...
class UserModel {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield database_1.default
                    .getPool()
                    .query("SELECT id, first_name, last_name, password, system_id FROM users WHERE email = $1", [email]);
    ...
    static registerUser(firstName, lastName, email, systemID, password) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield database_1.default.initialize();
                ...
                const response = yield database_1.default
                    .getPool()
                    .query("INSERT INTO users (id, first_name, last_name, email, password, created_at, updated_at, deleted_at, is_active, system_id) VALUES ($1, $2, $3, $4, $5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, true, $6)", [userID, firstName, lastName, email, hashedPassword, systemID]);
                return {
                    userID: userID,
                    success: true,
                };
    ...
    static getAllEmailsPertainingToSystem(systemId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield database_1.default.initialize();
                const response = yield database_1.default
