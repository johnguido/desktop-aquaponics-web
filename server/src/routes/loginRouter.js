...
loginRouter.get("/register/checkIfSystemIdExists/:systemID", loginController_1.default.checkIfSystemIdExists);
loginRouter.get("/user/verify/:email/:password", loginController_1.default.verifyUser);
loginRouter.post("/register/user/:firstName/:lastName/:email/:systemID/:password", loginController_1.default.regiserUser);
