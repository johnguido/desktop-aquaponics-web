...
class LoginController {
    ...
    static checkIfSystemIdExists(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { systemID } = req.params;
            const response = yield systemModel_1.default.checkIfSystemIdExists(systemID);
            res.send({
                success: response.success,
    ...
    static regiserUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield userModel_1.default.registerUser(firstName, lastName, email, systemID, password);
            res.send({
                success: response.success,
